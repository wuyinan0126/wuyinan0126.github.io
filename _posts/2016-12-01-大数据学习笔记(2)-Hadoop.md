...
*简单学习Hadoop相关知识，并在集群上搭建Hadoop HA平台。包括介绍MapReduce计算框架、HDFS文件系统、YARN资源调度与管理系统*
...
3. etc/hadoop/hdfs-site.xml
		...
		<configuration>
		  ...
		  <property>  
		    ...
		    <value>qjournal://10.2.2.143:8485;10.2.2.144:8485;10.2.2.145:8485;10.2.2.146:8485;10.2.2.147:8485;10.2.2.148:8485;10.2.2.149:8485;10.2.2.150:8485;10.2.2.151:8485/cats</value> 
...
5. etc/hadoop/mapred-site.xml
		...
		<configuration>
		  ...
		  <property>  
		    ...
		    <value>1536</value>  
		    <description>每个Map Task需要的物理内存限制，例如需要1536MB内存时，yarn将分配一个2048MB内存(2*最小容器内存单位)的容器，这个值可以在程序中设定被覆盖</description>
		  </property>
		  <property>  
		    <name>mapreduce.reduce.memory.mb</name>  
		    <value>3072</value>  
		    <description>每个Reduce Task需要的物理内存限制，一般为Map的两倍，这个值可以在程序中设定被覆盖</description>
		  </property>
		  <property>  
		    <name>mapreduce.map.java.opts</name>  
		    <value>-Xmx1024m</value>  
		    <description>设置Map Task的JVM的堆空间大小，因为Map Task分配了1536MB内存，其中1024MB内存给了java、scala等程序，这个值可以在程序中设定被覆盖</description>
		  </property>
		  <property>  
...
8. etc/hadoop/yarn-site.xml
		...
		<configuration>
		  ...
		  <property>
		  	...
		  	<value>16384</value>
		  	<description>NodeManager总的可用物理内存</description>
		  </property>
		  <property>
...
2. (在主节点)检验集群是否格式化，ls /是否出现了hadoop-ha
